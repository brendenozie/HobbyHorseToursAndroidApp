...
import ke.co.tulivuapps.hobbyhorsetours.features.ui.theme.captionTextStyle
...
private fun CraneBaseUserInput(
    ...
    tintIcon: () -> Boolean,
    tint: Color = MaterialTheme.colors.surface,//LocalContentColor.current,
...
fun PreviewInput() {
    HobbyHorseToursAppTheme {
        Surface {
            CraneBaseUserInput(
                tintIcon = { true },
                vectorImageId = R.drawable.ic_arrow_right_icon,
                caption = "Caption",
                showCaption = { true }
            ) {
