...
package ke.co.tulivuapps.hobbyhorsetours.composebase.features.screen.hotelsdetail.navigation
...
import ke.co.tulivuapps.hobbyhorsetours.composebase.features.screen.hotelsdetail.HotelsDetailScreen
...
fun NavGraphBuilder.hotelsDetailScreen(navigateToBack: () -> Unit) {
    composable(
        hotelsDetailNavigationRoute.plus("?hotelDetail={characterDetail}"),
        content = {
            HotelsDetailScreen(
