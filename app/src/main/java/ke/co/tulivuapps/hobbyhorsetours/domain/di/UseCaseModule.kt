package ke.co.tulivuapps.hobbyhorsetours.domain.di
...
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.bookings.GetBookingsFilterUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.bookings.GetBookingsUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.characters.GetCharactersFilterUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.characters.GetCharactersUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.city.DeleteCityFavoriteUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.city.GetCityFavoritesUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.city.GetCityFilterUseCase
...
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.destinations.DeleteDestinationFavoriteUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.destinations.GetDestinationFavoritesUseCase
...
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.hotels.DeleteHotelFavoriteUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.hotels.GetHotelFavoritesUseCase
...
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.travelstyle.DeleteTravelStyleFavoriteUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.travelstyle.GetTravelStyleFavoritesUseCase
import ke.co.tulivuapps.hobbyhorsetours.domain.usecase.travelstyle.GetTravelStyleFilterUseCase
...
class UseCaseModule {
    ...
    // Bookings UseCase Module
    @ViewModelScoped
    @Provides
    fun provideGetBookingsUseCase(bookingsRepository: BookingsRepository) = GetBookingsUseCase(bookingsRepository)
    @ViewModelScoped
    @Provides
    fun provideGetBookingsFilterUseCase( bookingsRepository: BookingsRepository ) = GetBookingsFilterUseCase(bookingsRepository)
}